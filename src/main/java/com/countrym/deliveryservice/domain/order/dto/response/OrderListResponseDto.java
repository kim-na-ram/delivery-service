...
public class OrderListResponseDto {
    ...
    public static OrderListResponseDto from(OrderSimpleQueryDto orderSimpleQueryDto) {
        return new OrderListResponseDto(
                orderSimpleQueryDto.getOrderId(),
                orderSimpleQueryDto.getStoreId(),
                orderSimpleQueryDto.getStoreName(),
                orderSimpleQueryDto.getOrderedMenuList().stream().map(OrderedMenuResponseDto::from).toList(),
                orderSimpleQueryDto.getOrderedPrice(),
                orderSimpleQueryDto.getOrderStatus(),
                orderSimpleQueryDto.getOrderedAt(),
                orderSimpleQueryDto.getCanceledAt(),
                orderSimpleQueryDto.isReviewed()
        );
    }
}